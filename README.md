...
Note: JLPT 0 แทนค่าด้วยคันจิในชีวิตประจำวันที่อยู่นอกเหนือจากการสอบวัดระดับภาษาญี่ปุ่น
...
Grade3 + Grade4 ≈ JLPT3
Grade5 + Grade6 ≈ JLPT2
Grade7          ≈ JLPT1 + คันจิในชีวิตประจำวันที่อยู่นอกเหนือจากการสอบวัดระดับภาษาญี่ปุ่น
``` 
...
```
JLPT4(เก่า) ≈ JLPT5(ใหม่)
JLPT3(เก่า) ≈ JLPT4(ใหม่)
JLPT2(เก่า) ≈ JLPT3(ใหม่) ＋ JLPT2(ใหม่)
JLPT1(เก่า) ≈ JLPT1(ใหม่)
```

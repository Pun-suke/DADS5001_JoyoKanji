...
Note：上 แปลว่า ข้างบน ขึ้น / 下 แปลว่า ข้างล่าง ลง / 生 แปลว่า เกิด สด(ใหม่)



**ประเด็นที่ 5:** การกระจายตัวของจำนวนเสียง On และ Kun ของคันจิในชีวิตประจำวัน

คันจิมีรากมาจากจีน จะเน้นเสียงอ่านไปทางเสียงจีนมากกว่าเสียงญี่ปุ่นหรือไม่
...
หนังสือพิมพ์ไมนิจิเป็นสื่อที่จะพบเจอคำศัพท์ที่ใช้คันจิในชีวิตประจำวันซ้ำๆ ซึ่งเหมาะแก่การฝึกภาษาที่ควรย้ำสิ่งเดิมๆหลายๆครั้งให้จำและเข้าได้หรือไม่
...
เนื่องจากตัวเลขเป็นยอดสะสม 11 ปี (2000-2010) จึงเห็นได้ว่าความซ้ำของคำศัพท์ในหนังสือพิมพ์มีการปรากฎตัวมีค่อนข้างต่ำมาก จากการที่คำศัพท์เกินกว่ากึ่งหนึ่งปรากฎต่ำกว่า 100 ครั้ง ในช่วงเวลา 11 ปี กลับกันคำซ้ำบางกลุ่มซึ่งมีจำนวนไม่มาก มีความกระจุกตัวซ้ำมากถึง 2 แสนครั้ง ซึ่งสามารถบอกได้ว่าหนังสือพิมพ์เหมาะสำหรับการเรียนศัพท์ใหม่ๆที่ปรากฎตัวออกมาน้อยครั้งมากกว่า ใช้เป็นสื่อในการฝึกคำศัพท์ซ้ำๆย้ำๆให้คุ้นเคยได้
